...
module.exports.policies = {
  ...
  UserController: {
    ...
    updateProfile: ["isLoggedIn", "isAdminOrNurse"],
  ...
  ConsultationController: {
    ...
    rescheduleConsultation: ["isLoggedIn", "isConsultationParticipant"],
  ...
  PublicInviteController: {
    ...
    createFhirAppointment: ["isLoggedIn", "canInvite"],
    getFhirAppointment: ["isLoggedIn", "canInvite"],
