...
const DELETE_OPEN_CONSULTATION_AFTER = process.env.DELETE_OPEN_CONSULTATION_AFTER;
...
const CONSULTATION_TIMEOUT = parseTime(DELETE_OPEN_CONSULTATION_AFTER, DEFAULT_CONSULTATION_TIMEOUT);
